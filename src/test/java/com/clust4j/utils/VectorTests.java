...
public class VectorTests {
    ...
    public void testArange() {
        ...
        try {
            p = false;
            VecUtils.arange(Integer.MAX_VALUE);
        } catch (IllegalArgumentException e) {
            p = true;
        } finally {
            if (!p) fail();
        ...
        try {
            p = false;
            VecUtils.arange(0, Integer.MAX_VALUE);
        } catch (IllegalArgumentException e) {
            p = true;
        } finally {
            if (!p) fail();
        ...
        try {
            p = false;
            VecUtils.arange(0, Integer.MAX_VALUE, 1);
        } catch (IllegalArgumentException e) {
            p = true;
        } finally {
            if (!p) fail();
    ...
    public void testCosSim2() {
        ...
        try {
            p = false;
            VecUtils.cosSim(new double[]{1}, new double[]{1, 2});
        } catch (DimensionMismatchException e) {
            p = true;
        } finally {
            if (!p) fail();
    ...
    public void testDivide() {
        ...
        try {
            p = false;
            VecUtils.divide(new double[]{1}, new double[]{1, 2});
        } catch (DimensionMismatchException e) {
            p = true;
        } finally {
            if (!p) fail();
    ...
    public void testVecSeries() {
        ...
        try {
            p = false;
            new DoubleSeries(va, Inequality.EQUAL_TO, new double[]{1, 1});
        } catch (DimensionMismatchException e) {
            p = true;
        } finally {
            if (!p) fail();
        ...
        try {
            p = false;
            new DoubleSeries(va, Inequality.EQUAL_TO, new double[]{});
        } catch (DimensionMismatchException e) {
            p = true;
        } finally {
            if (!p) fail();
        ...
        try {
            p = false;
            new DoubleSeries(new double[]{}, Inequality.EQUAL_TO, vb);
        } catch (IllegalArgumentException e) {
            p = true;
        } finally {
            if (!p) fail();
