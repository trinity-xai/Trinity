...
public final class Graph3DRenderer {
    ...
    public static final class Params {
        ...
        public Params withNodeRadius(double r) {
            nodeRadius = r;
            return this;
        }

        public Params withNodeDivisions(int d) {
            nodeDivisions = d;
            return this;
        }

        public Params withEdgeWidth(float w) {
            edgeWidth = w;
            return this;
        }

        public Params withPositionScalar(double s) {
            positionScalar = s;
            return this;
        }

        public Params withDefaultNodeColor(Color c) {
            if (c != null) {
                defaultNodeColor = c;
            }
            return this;
        ...
        public Params withDefaultEdgeColor(Color c) {
            if (c != null) {
                defaultEdgeColor = c;
            }
            return this;
    ...
    public static Group buildGraphGroup(GraphDirectedCollection graph, Params params) {
        ...
        for (GraphNode gN : graph.getNodes()) {
            ...
            s.setTranslateX(p3.x);
            s.setTranslateY(p3.y);
            s.setTranslateZ(p3.z);
            s.setUserData(gN);
            ...
            s.setOnMouseMoved(e -> {
                ...
                if (sc != null && sc.getRoot() != null) {
                    sc.getRoot().fireEvent(new GraphEvent(GraphEvent.GRAPH_NODE_HOVER, gN));
                }
            });
            s.setOnMouseClicked(e -> {
                Scene sc = s.getScene();
                if (sc != null && sc.getRoot() != null) {
                    sc.getRoot().fireEvent(new GraphEvent(GraphEvent.GRAPH_NODE_CLICK, gN));
                }
            });
        ...
        for (GraphEdge ge : graph.getEdges()) {
            ...
            t.setOnMouseMoved(e -> {
                Scene sc = t.getScene();
                if (sc != null && sc.getRoot() != null) {
                    sc.getRoot().fireEvent(new GraphEvent(GraphEvent.GRAPH_EDGE_HOVER, ge));
                }
            });
            t.setOnMouseClicked(e -> {
                Scene sc = t.getScene();
                if (sc != null && sc.getRoot() != null) {
                    sc.getRoot().fireEvent(new GraphEvent(GraphEvent.GRAPH_EDGE_CLICK, ge));
                }
            });
