...
/**
 * A pane containing a dynamic resizable canvas with convienece methods for
 * transforming and plotting data like a scatter plot.
 ...
 * Taken from LitFX
 */
public class ShadowPane extends CanvasOverlayPane {
    ...
    public ShadowPane(boolean debugBorder, boolean clearCanvas) {
        this(new Canvas(), debugBorder, clearCanvas);
    }

    public ShadowPane(boolean debugBorder, boolean clearCanvas, Rectangle rectangle) {
        this(new Canvas(), debugBorder, clearCanvas, rectangle);
    }

    public ShadowPane(Canvas canvas, boolean debugBorder, boolean clearCanvas) {
        this(canvas, debugBorder, clearCanvas, null);
    }

    public ShadowPane(Canvas canvas, boolean debugBorder, boolean clearCanvas, Rectangle rectangle) {
