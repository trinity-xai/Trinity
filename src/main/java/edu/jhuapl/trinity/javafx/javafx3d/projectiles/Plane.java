...
public final class Plane {
    ...
    *           The z component of the plane normal
    * @param _d
    *           The negative distance between the plane and the origin in the direction of the normal.
    */
...
//   }
    ...
    *           A point on the plane.
    * @param x
    *           The x component of the point to find the distance to.W
    * @param y
    *           The y component of the point to find the distance to.W
    * @param z
    *           The z component of the point to find the distance to.W
