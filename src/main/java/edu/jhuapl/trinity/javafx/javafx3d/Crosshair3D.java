...
public class Crosshair3D extends Group {
    ...
    public void setCenter(Point3D newCenter) {
        ...
        xPositiveData.add(new org.fxyz3d.geometry.Point3D(half, startPointY, startPointZ));
        ...
        xNegativeData.add(new org.fxyz3d.geometry.Point3D(-half, startPointY, startPointZ));
        ...
        yPositiveData.add(new org.fxyz3d.geometry.Point3D(startPointX, half, startPointZ));
        ...
        yNegativeData.add(new org.fxyz3d.geometry.Point3D(startPointX, -half, startPointZ));
        ...
        zPositiveData.add(new org.fxyz3d.geometry.Point3D(startPointX, startPointY, half));
        ...
        zNegativeData.add(new org.fxyz3d.geometry.Point3D(startPointX, startPointY, -half));
