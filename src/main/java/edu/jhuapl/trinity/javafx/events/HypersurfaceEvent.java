...
public class HypersurfaceEvent extends Event {
    ...
    public HypersurfaceEvent(EventType<? extends Event> type) {
        super(type);
    }
    ...
    public static HypersurfaceEvent of(EventType<HypersurfaceEvent> type) {
        return new HypersurfaceEvent(type);
    }

    public static HypersurfaceEvent of(EventType<HypersurfaceEvent> type, Object payload) {
        return new HypersurfaceEvent(type, payload);
    }

    // Examples: (for all existing events)
    public static HypersurfaceEvent yScale(double v) {
        return of(Y_SCALE_CHANGED, v);
    }

    public static HypersurfaceEvent surfScale(double v) {
        return of(SURF_SCALE_CHANGED, v);
    }

    public static HypersurfaceEvent xWidth(int v) {
        return of(XWIDTH_CHANGED, v);
    }

    public static HypersurfaceEvent zWidth(int v) {
        return of(ZWIDTH_CHANGED, v);
    }

    public static HypersurfaceEvent surfaceRender(boolean surface) {
        return of(SURFACE_RENDER_CHANGED, surface);
    }

    public static HypersurfaceEvent drawMode(Object drawMode) {
        return of(DRAW_MODE_CHANGED, drawMode);
    }

    public static HypersurfaceEvent cullFace(Object cullFace) {
        return of(CULL_FACE_CHANGED, cullFace);
    }

    public static HypersurfaceEvent coloration(Object colorationEnum) {
        return of(COLORATION_CHANGED, colorationEnum);
    }

    public static HypersurfaceEvent interp(Object interpEnum) {
        return of(INTERP_MODE_CHANGED, interpEnum);
    }

    public static HypersurfaceEvent smoothingEnabled(boolean b) {
        return of(SMOOTHING_ENABLE_CHANGED, b);
    }

    public static HypersurfaceEvent smoothingMethod(Object methodEnum) {
        return of(SMOOTHING_METHOD_CHANGED, methodEnum);
    }

    public static HypersurfaceEvent smoothingRadius(int r) {
        return of(SMOOTHING_RADIUS_CHANGED, r);
    }

    public static HypersurfaceEvent gaussianSigma(double s) {
        return of(GAUSSIAN_SIGMA_CHANGED, s);
    }

    public static HypersurfaceEvent toneEnabled(boolean b) {
        return of(TONEMAP_ENABLE_CHANGED, b);
    }

    public static HypersurfaceEvent toneOperator(Object opEnum) {
        return of(TONEMAP_OPERATOR_CHANGED, opEnum);
    }

    public static HypersurfaceEvent toneParam(double v) {
        return of(TONEMAP_PARAM_CHANGED, v);
    }

    public static HypersurfaceEvent heightMode(Object modeEnum) {
        return of(HEIGHT_MODE_CHANGED, modeEnum);
    }

    public static HypersurfaceEvent ambientEnabled(boolean b) {
        return of(AMBIENT_ENABLED_CHANGED, b);
    }

    public static HypersurfaceEvent ambientColor(Object color) {
        return of(AMBIENT_COLOR_CHANGED, color);
    }
    ...
    public static HypersurfaceEvent specularColor(Object color) {
        return of(SPECULAR_COLOR_CHANGED, color);
    }

    public static HypersurfaceEvent hoverEnabled(boolean b) {
        return of(HOVER_ENABLE_CHANGED, b);
    }

    public static HypersurfaceEvent surfaceChartsEnabled(boolean b) {
        return of(SURFACE_CHARTS_ENABLE_CHANGED, b);
    }

    public static HypersurfaceEvent dataMarkersEnabled(boolean b) {
        return of(DATA_MARKERS_ENABLE_CHANGED, b);
    }
    ...
    public static HypersurfaceEvent resetView() {
        return of(RESET_VIEW);
    }

    public static HypersurfaceEvent updateRender() {
        return of(UPDATE_RENDER);
    }

    public static HypersurfaceEvent clearData() {
        return of(CLEAR_DATA);
    }

    public static HypersurfaceEvent unroll() {
        return of(UNROLL_REQUESTED);
    }

    public static HypersurfaceEvent computeVectorDistances() {
        return of(COMPUTE_VECTOR_DISTANCES);
    }

    public static HypersurfaceEvent computeCollectionDiff(Object featureCollection) {
        return of(COMPUTE_COLLECTION_DIFF, featureCollection);
    }

    public static HypersurfaceEvent computeCosineDistance(Object featureCollection) {
        return of(COMPUTE_COSINE_DISTANCE, featureCollection);
    }

    // --- Factories for GUI sync events ---
    public static HypersurfaceEvent setXWidthGUI(int v) {
        return of(SET_XWIDTH_GUI, v);
    }

    public static HypersurfaceEvent setZWidthGUI(int v) {
        return of(SET_ZWIDTH_GUI, v);
    }

    public static HypersurfaceEvent setYScaleGUI(double v) {
        return of(SET_YSCALE_GUI, v);
    }

    public static HypersurfaceEvent setSurfScaleGUI(double v) {
        return of(SET_SURFSCALE_GUI, v);
    }
}
