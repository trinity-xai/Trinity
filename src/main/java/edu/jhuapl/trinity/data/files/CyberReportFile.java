 ...
 */
public class CyberReportFile extends File implements Transferable {
    private static final Logger LOG = LoggerFactory.getLogger(CyberReportFile.class);
    public static final DataFlavor DATA_FLAVOR = new DataFlavor(CyberReportFile.class, "CYBERREPORT");
     ...
     */
    public CyberReportFile(String pathname) {
        super(pathname);
    }
     ...
     */
    public CyberReportFile(String pathname, Boolean parseExisting) throws IOException {
        super(pathname);
        if (parseExisting)
            parseContent();
    }
     ...
     * @throws java.io.IOException
     */
    public static boolean isCyberReportFile(File file) throws IOException {
    ...
    private CyberReport parseContent() throws IOException {
