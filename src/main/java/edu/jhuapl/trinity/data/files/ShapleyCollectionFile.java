...
public class ShapleyCollectionFile extends File implements Transferable {
    ...
    public ShapleyCollection shapleyCollection = null;
     ...
     */
    public ShapleyCollectionFile(String pathname) {
        super(pathname);
    }
     ...
     */
    public ShapleyCollectionFile(String pathname, Boolean parseExisting) throws IOException {
        super(pathname);
        if (parseExisting)
            parseContent();
    }
    ...
    private ShapleyCollection parseContent() throws IOException {
        /** Provides deserialization support for JSON messages */
        ObjectMapper mapper = new ObjectMapper();
        mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
        String message = Files.readString(this.toPath());
        shapleyCollection = mapper.readValue(message, ShapleyCollection.class);
        return shapleyCollection;
    }
