...
//                )
    ...
    public static Paint getFillForStyle(PlanetStyle style) {
        return switch (style) {
            ...
            case AI_OVERLORD -> new LinearGradient(0, 0, 0, 1, true, CycleMethod.NO_CYCLE,
                new Stop(0, Color.web("#003344")),
                new Stop(1, Color.web("#00CCFF")));
            case HOSTILE_AI -> new LinearGradient(0, 0, 0, 1, true, CycleMethod.NO_CYCLE,
            ...
            case NIGHTSIDE_EARTH -> new RadialGradient(0, 0, 0.5, 0.5, 0.5, true, CycleMethod.NO_CYCLE,
                new Stop(0, Color.NAVY), // deep ocean blue
                new Stop(1, Color.BLACK));  // black

            case URBAN_WORLD -> new LinearGradient(0, 0, 0, 1, true, CycleMethod.NO_CYCLE,
