...
public final class GraphLayoutParams implements Serializable {
    ...
    public GraphLayoutParams withKind(LayoutKind k) {
        this.kind = k;
        return this;
    }

    public GraphLayoutParams withRadius(double r) {
        this.radius = r;
        return this;
    }

    // Force
    public GraphLayoutParams withIterations(int it) {
        this.iterations = it;
        return this;
    }

    public GraphLayoutParams withStep(double s) {
        this.step = s;
        return this;
    }

    public GraphLayoutParams withRepulsion(double r) {
        this.repulsion = r;
        return this;
    }

    public GraphLayoutParams withAttraction(double a) {
        this.attraction = a;
        return this;
    }

    public GraphLayoutParams withGravity(double g) {
        this.gravity = g;
        return this;
    }

    public GraphLayoutParams withCooling(double c) {
        this.cooling = c;
        return this;
    }

    // Edges
    public GraphLayoutParams withEdgePolicy(EdgePolicy p) {
        this.edgePolicy = p;
        return this;
    }

    public GraphLayoutParams withKnnK(int k) {
        this.knnK = k;
        return this;
    }

    public GraphLayoutParams withKnnSymmetrize(boolean s) {
        this.knnSymmetrize = s;
        return this;
    }

    public GraphLayoutParams withEpsilon(double e) {
        this.epsilon = e;
        return this;
    }

    public GraphLayoutParams withBuildMst(boolean b) {
        this.buildMst = b;
        return this;
    }

    public GraphLayoutParams withMaxEdges(int e) {
        this.maxEdges = e;
        return this;
    }

    public GraphLayoutParams withMaxDegreePerNode(int d) {
        this.maxDegreePerNode = d;
        return this;
    }

    public GraphLayoutParams withMinEdgeWeight(double w) {
        this.minEdgeWeight = w;
        return this;
    }

    public GraphLayoutParams withNormalizeWeights01(boolean on) {
        this.normalizeWeights01 = on;
        return this;
    }
}
