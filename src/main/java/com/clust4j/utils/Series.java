...
public abstract class Series<T> {
    ...
    public static enum Inequality implements Evaluator {
        ...
        NOT_EQUAL_TO {
            @Override
            public boolean eval(double a, double b) {
                return !EQUAL_TO.eval(a, b);
            }
        },
        ;
    }

    final public boolean eval(final double a, final double b) {
        return eval(a, in, b);
    }

    final public static boolean eval(final double a, final Inequality in, final double b) {
        return in.eval(a, b);
    }
