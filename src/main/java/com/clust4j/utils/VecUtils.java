...
public abstract class VecUtils {
    ...
    // =============== DIM CHECKS ==============
    final private static void dimAssess(final int a) {
        if (a < MIN_ACCEPTABLE_VEC_LEN) throw new IllegalArgumentException(VEC_LEN_ERR + a);
    }
    ...
    final private static void dimAssessPermitEmpty(final int a) {
        if (a < 0) throw new IllegalArgumentException(VEC_LEN_ERR + a);
    }

    final static public void checkDimsPermitEmpty(final boolean[] a) {
        dimAssessPermitEmpty(a.length);
    }
    ...
    final private static void dimAssess(final int a, final int b) {
        if (a != b) throw new DimensionMismatchException(a, b);
        dimAssess(a);
    }

    final static public void checkDims(final boolean[] a, final boolean[] b) {
        dimAssess(a.length, b.length);
    }
    ...
    final static public void checkDimsPermitEmpty(final boolean[] a, final boolean[] b) {
        dimAssessPermitEmpty(a.length, b.length);
    }
